...
<head>
    ...
    <link rel="icon" type="shortcut-icon" href="../img/favicon/settings.png">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: center;font-size: 25px;font-weight: 500;">Account Details</p><br><br>
                                </td>
                            </tr>
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: center;font-size: 25px;font-weight: 500;">Edit Account Details</p>
                                        Account ID : '.$id.'<br><br>
                                        </td>
                                    </tr>
                                    <tr>
