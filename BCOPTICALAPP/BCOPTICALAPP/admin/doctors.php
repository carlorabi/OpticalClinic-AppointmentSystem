...
<head>
    ...
    <link rel="icon" type="shortcut-icon" href="../img/homepage/faviconlogo.png">
    <link rel="icon" type="shortcut-icon" href="../img/favicon/doctor.png">
...
?>
                ...
                <tr >
                    <td colspan="2" style="padding-top:30px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Doctor Information</p>
                    </td>
                    <td colspan="2">
    ...
    if($_GET){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: center;font-size: 25px;font-weight: 500;">Doctor Details</p><br><br>
                                </td>
                            </tr>
        ...
        // add doctor function
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <form action="add-newdoc.php" method="POST" class="add-new-form">
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">Name: </label>
                                </td>
                            </tr>
            ...
            // message prompt when successfully added doctor
            }else{
                echo '
                    <div id="popup1" class="overlay">
                            <div class="popup">
        ...
        // edit doctor function
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="password" class="input-text" placeholder="New Password" value="'.$dpassword.'" required><br>
                                        </td>
                                    </tr><tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="cpassword" class="input-text" placeholder="Confirm Password" value="'.$dpassword.'" required><br>
                                        </td>
                                    </tr>
            ...
            // message prompt when edit successfully
            }else{
            echo '
                <div id="popup1" class="overlay">
                        <div class="popup">
